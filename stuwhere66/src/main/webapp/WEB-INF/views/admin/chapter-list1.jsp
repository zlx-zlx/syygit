...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>个人信息管理 <span class="c-gray en">&gt;</span>查看个人信息  
...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	 <span class="l"> <a class="btn btn-primary radius" onclick="member_add('添加老师','admin/chapter-add?schCode=${school.schCode }&schName=${school.schName }')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加老师</a></span>
				...
				<tr class="text-c">
				   ...
				   <td>${teacher.schCode }</td>
					...
					<td><fmt:formatDate value="${teacher.teaCreateTime}"
					 ...
					 <a style="text-decoration:none" class="ml-5" onClick="article_edit('修改信息','admin/toUpdateTeacherUi?teaId=${teacher.teaId}','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function member_del(obj, teaId) {
	layer.confirm('确认要删除吗？', function(index) {
		...
		$.ajax({
			...
			url: 'admin/deleteTeacher?teaId='+teaId,
			dataType: 'json',
			success: function(data){
				if(data==1){
				   ...
				   // location.href="admin/adminShowSchool";
					...
					location.href="admin/chapterShowTable2";
				}
			},
			error:function(data) {
