...
<div class="pd-20">
	<form action="teacher/studentUpdate222" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div>
		  <input type="hidden" name="stuCreateTime" value="<fmt:formatDate value="${student.stuCreateTime}" pattern="yyyy-MM-dd"/> ">
		...
		<div>
			...
			<div>
			<input type="hidden"   name="stuPass"   value="${student.stuPass}" >
			 </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text"    class="input-text" id="" name="schCode"  datatype="*"   value="${student.schCode}"  readonly="true">
		...
		<label class="form-label col-2"><span class="c-red">*</span>所属学校：</label>
			<div class="formControls col-2"> <span class="select-box">
				<select name="schName" class="select">
		 ...
		 <div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>联系电话：</label>
			<div class="formControls col-2">
			<input   title="请输入正确的手机号格式"    pattern="^((13[0-9])|(14[0-9])|(15[0-9])|(16[0-9])|(17[0-9])|(18[0-9])|(19[0-9]))\d{8}$"    type="text" class="input-text"  id="" name="stuPhone" datatype="*"   value="${student.stuPhone}"    nullmsg="请输入手机号码"      >
			</div>
