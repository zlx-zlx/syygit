...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 职务管理 <span class="c-gray en">&gt;</span>职务信息<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace('<%=basePath%>admin/showPo');" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>

			<div class="pd-20">
			 <form action="admin/selectPo" method="post">
	        <div class="text-c"> 
	       
		<input type="text" name="poName"  id="select" placeholder="职务名称" style="width:100px" class="input-text">
	...
	<span class="l"> 
	<a href="javascript:;" onclick="member_add('添加职务','<%=path%>/admin/toAddPo','600','300')" 
				class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加职务</a>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr class="text-c">
					...
					<th width="350">序号</th>
					<th width="350">职务名称</th>
					
					<th width="350">职务编号</th>
			...
			<tbody>
				<c:forEach items="${listPo }" var="po"  varStatus="sta">
					<tr class="text-c">
						<td>${sta.count }</td>
						<td>${po.poName }</td>
					 ...
					 <a style="text-decoration:none" class="ml-5" onClick="member_edit('修改','admin/toUpdatePoUi?poId=${po.poId}','300','500','300')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a title="删除" href="javascript:;" onclick="member_del(this,'${po.poId }')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
...
/*用户-删除*/
function member_del(obj, poId) {
	layer.confirm('确认要删除吗？', function(index) {
		$(obj).parents("tr").remove();
		$.ajax({
			type: 'POST',
			
			url: 'admin/deletePo?poId='+poId,
			dataType: 'json',
