	...
	<form action="student/updateNews" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-2"> <span class="select-box">
				<select name="stuSex" class="select"   datetype="*"  nullmsg="请选择性别!" >
		...
		<%--  <div class="row cl">
			...
			<div class="formControls col-2"> <span class="select-box">
				 <select name="schName" class="select" datatype="*" nullmsg="请选择学校名称！">
					<option value="" selected><c:forEach items="${students }" var="studentss">
				${studentss.school.schName }
			   </c:forEach></option>
			   <c:forEach items="${school }" var="school">
		...
		<div class="row cl">
			...
			<div class="formControls col-2"> <span class="select-box">
				<select name="stuStatus" class="select" datatype="*" nullmsg="请选择毕业动态">
					<option value="${student.stuStatus}" selected>${student.stuStatus}</option>
		...
		<div class="row cl">
			...
			<select name="stuEducation"  class="select" datatype="*" >
					<option value="${student.stuEducation}" selected>${student.stuEducation}</option>
