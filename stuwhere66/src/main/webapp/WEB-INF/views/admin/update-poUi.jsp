...
<div class="pd-20">
	<form action="admin/poUpdate" method="post" class="form form-horizontal" id="form-article-add">
		
		<div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>职务名称：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text"   id="poNameid" name="poName"  nullmsg="职务名称不能为空" datatype="*"  value="${po.poName}" >
    ...
    <div class="row cl">
      <label class="form-label col-3">职务编号：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text"    id="poCodeid" name="poCode"  nullmsg="职务编号不能为空" datatype="n4-10"  value="${po.poCode}" >
      ...
      <div class="col-4"> </div>
		...
		<div>
		  <input type="hidden" name="poFlag"  value="0" >
