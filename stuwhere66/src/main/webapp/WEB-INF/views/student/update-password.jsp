...
<body>
<div class="pd-20">
	<form action="student/updatePassword" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			<label class="form-label col-4"><span class="c-red">*</span>用户名：</label>
			<div class="formControls col-4"> 
			<input type="" class="input-text" autocomplete="off" value="${student.stuNo }" name="stuNo"   id=""   ignore="ignore" readonly="true" >
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="password" class="input-text"  autocomplete="off" placeholder="请输入6位及以上字符" name="stuPass" id="newPasswordone" datatype="*6-18" ignore="ignore" >
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="password" class="input-text" autocomplete="off" placeholder="请再输一遍密码" name="stuPass2" id="newPasswordtwo" recheck="stuPass" datatype="*6-18" errormsg="您两次输入的密码不一致！" ignore="ignore" >
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
