			...
			<tbody>
				<c:forEach items="${listSchools }" var="school"  varStatus="sta">
					<tr class="text-c">
						...
						<td>
							<a href="javascript:;" onclick="chapterPractice(this,'${school.schCode}')" class="btn btn-danger radius"> 学校校区</a> 
						</td>
					</tr>
				</c:forEach>
			</tbody>
...
function chapterPractice(obj,schCode){
	//alert(chapterId);
	window.location.href="${pageContext.request.contextPath}/teacher/toQuestionInfo4?schCode="+schCode;
}
</script> 
</body>
</html>