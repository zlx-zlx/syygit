...
<div class="pd-20">
	<form action="student/insertWay" method="post" class="form form-horizontal" id="form-article-add">
	...
	<div >
			...
			<input type="hidden"  id="" name="schCode"  value="${student.schCode}" >
			<input type="hidden"  id="" name="wayCreateBy"  value="${student.stuName}" >
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" id="test1" name="wayTime" placeholder="yyyy-MM-dd" datatype="*"  >
