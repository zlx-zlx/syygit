...
<div class="pd-20">
	<form action="student/updateNews" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-2"> <span class="select-box">
				<select name="stuSex" class="select" datatype="*"  >
					<option value="" selected>${student.stuSex}</option>
		...
		<label class="form-label col-2"><span class="c-red">*</span>所属学校：</label>
			<div class="formControls col-2"> <span class="select-box">
				<select name="schName" class="select" datatype="*"  >
		...
		<div class="row cl">
			<label class="form-label col-2">专业：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text"  name="stuMajor"   value="${student.stuMajor}">
			</div> 
		</div>
...
<div class="pd-20">
	<form action="teacher/updateWays123" method="post" class="form form-horizontal" id="form-article-add">
	...
	<input type="hidden"  id="" name="wayId" value="${way.wayId}">
		...
		<div>
		  <input type="hidden" name="wayCreateTime" value="<fmt:formatDate value="${way.wayCreateTime}" pattern="yyyy-MM-dd"/> ">
		...
		<div>
			<input type="hidden"   name="wayCreateBy"   value="${way.wayCreateBy}" >
			 </div>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>学号：</label>
			<div class="formControls col-2">
			<input type="text" class="input-text"  id="" name="stuNo" datatype="*"  value="${way.stuNo}" readonly="true">
			 </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-2">
			<input  datatype="n1-9" type="text" class="input-text"  errormsg="请输入正确的格式"  id="" name="waySalary"  value="${way.waySalary}"   >
			<!-- ^\S{1,9}$
			/^(\d{1,2})$/ -->
			</div>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>从事职务：</label>
			<div class="formControls col-2"> <span class="select-box">
				<select name="poName" class="select"    nullmsg="请选择职务名称！">
				<c:forEach items="${position }" var="position">
					<option>${position.poName }</option>
				</c:forEach>
				</select>
