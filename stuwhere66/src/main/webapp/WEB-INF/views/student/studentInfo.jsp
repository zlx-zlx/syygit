...
<div class="pd-20">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			<c:forEach items="${student }" var="studentss">
				<tr class="text-c">
					<td>${studentss.stuId }</td>
					...
					<td>${studentss.stuNo }</td>
					<td>${studentss.stuName }</td>
					<td>${studentss.school.schName }</td>
					
					<td>${studentss.schCode }</td>
...
<div class="pd-10" style="padding-top:20px;">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" class="btn btn-success radius" onClick="change_password('修改密码','student/toUpdatePassword','10001','600','500')" href="javascript:;" title="修改密码">修改密码</button>
